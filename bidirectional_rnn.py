...
def static_rnn(cell, inputs, initial_state=None, dtype=None,
    ...
    with vs.variable_scope(scope or "rnn") as varscope:
        ...
        for time, input_ in enumerate(inputs):
            ...
            outputs.append(output)
        return (outputs, state,stateList)
...
def static_bidirectional_rnn(cell_fw, cell_bw, inputs,
    ...
    with vs.variable_scope(scope or "bidirectional_rnn"):
        ...
        with vs.variable_scope("fw") as fw_scope:
            output_fw, output_state_fw,output_stateList_fw = static_rnn(
        ...
        with vs.variable_scope("bw") as bw_scope:
            ...
            tmp, output_state_bw,output_stateList_bw = static_rnn(
    ...
    return (outputs, output_state_fw, output_state_bw,output_stateList_fw,output_stateList_bw)
